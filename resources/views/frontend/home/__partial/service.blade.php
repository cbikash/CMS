    ...
    <div class="container">
       <div class="row">
        <div class="col-md-12 div-top-section">
          <p class="header-class">{{$service->title}}</p>
          <p> <a href="/">HOME</a> > <a href="{{route('front.services')}}">Service</a> > {{$service->title}}  </p>
        </div>
      </div>
    </div>
</div>
     ...
     <div class="container">
         <div class="row">
            <div class="col-md-3">
                 ...
                 <ul class="list-group list-group-flush">
                   @foreach ($services as $item)
                       <li class="list-group-item"><a href="{{route('front.service',$item)}}"> {{$service->title}} </a></li>
                   @endforeach
                </ul>
            ...
            <div class="colver-img">
                <h3 class="title-product-man"><a href="#"><b>{{$service->title}}</b></a> </h3> 
                      
                <img src="{{asset('storage/service/'.$service->coverImage)}}" class="img-fluid img-cover" alt="{{$service->title}}">
                <div class="row">
                    <div class="col-md-12">
                        <h3>{{$service->title}}</h3>
                    </div>
